...
public class MTCosineSimilarityCalculator 
	...
	public static void main(String[] args) 
        ...
        MultithreadedMapper.setMapperClass(job, MTCosineSimilarityCalculator.class);
        ...
        job.setJarByClass(MTCosineSimilarityCalculator.class);
